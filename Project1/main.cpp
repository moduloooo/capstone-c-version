...
void setupVertices(void) { 
	...
	//int sphereIndices = mySphere.getNumIndices();
	//for (int i = 0; i < sphereIndices; i++) {
...
void init(GLFWwindow* window) {
	...
	sphereLocX = -1.0f; sphereLocY = 1.0f; sphereLocZ = 0.0f;
...
int main(void) {
	...
	GLFWwindow *window = glfwCreateWindow(600, 600, "Capstone!!", NULL, NULL);
